...
<Dropdown style={{width: '10vh'}}>
  <Dropdown.Toggle >
    <img
     className="menu-duck"
     src="assets\menu.png"
     alt="yellow rubber duckie that triggers the menu"></img>
  </Dropdown.Toggle>
  ...
  <Dropdown.Menu>
    ...
    :
    <>
    <Dropdown.Item onClick={() => SignOut()}><Link to="/Logout">Logout</Link></Dropdown.Item>
...
{/* <div>
    <img
     className="user-duck"
     src="assets\menu.png"
     alt="yellow rubber duckie that represents the user">
    </img>
</div> */}
</>
    )
